<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="hm-bannermain.aspx.cs" Inherits="ad_single_advertisement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 1920px x 822px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="AdsBannerDelete"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ddlSearchCategory" Name="AdsCategoryID" DefaultValue="5" PropertyName="SelectedValue"
                Type="String" />
