<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="hm-product.aspx.cs" Inherits="ad_single_product" %>
                        ...
                        <ItemTemplate>
                            <div style="width: 36px">
                                <img alt="Thư viện ảnh" title="Thư viện ảnh" src="../assets/images/PhotoAlbum.png"
                                    onclick="openWindow('hm-productphotoalbum.aspx?PI=<%# Eval("ProductID") %>','Thư viện ảnh')"
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 270px x 245px)</span>
                                        ...
                                        <div class="sub_box">
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    ...
                                                    <span class="required">(Kích thước 850px x 771px)</span>
